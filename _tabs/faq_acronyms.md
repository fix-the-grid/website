...
- FERC is the Federal Energy Regulatory Commission (FERC). It is an independent agency that [regulates](https://www.ferc.gov/what-ferc-does)interstate natural gas pipelines, LNG terminals, and hydropower plants, and the interstate transmission of natural gas, oil, and electricity
- FERC also regulates all ISOs/RTOs across the country, including ISO New England. As the ISO-NE [website](https://www.iso-ne.com/participate/filings-orders/ferc-filings/)explains, some ISO-NE actions require approval from FERC, including changes to market rules. The ISO-NE in general must comply with FERC rules and rule changes.

### What is NEPOOL and what does it do?

- The ISO-NE has control over proposing changes related to its own structure and electricity market rules, however, it must do so in consultation with the [New England Power Pool (NEPOOL).](https://nepool.com/about-nepool/) NEPOOL consists of all the designated participants in ISO markets plus other designated stakeholders, including generators, transmission owners, energy service companies, electric consumers, and nonprofits. FERC approved this body to advise and vote on ISO-NE electric market rules and transmission tariffs.
...
- NEPOOL existed before FERC and ISO-NE were created. A timeline with simple explanations of the reasons for creating each of the organizations is [here](https://www.iso-ne.com/about/what-we-do/history/).
- The relationship between ISO-NE and NEPOOL is defined in a [participants agreement](https://www.iso-ne.com/static-assets/documents/2015/10/parts_agree.pdfoverning-agreements/participants-nescoe-mou/) with [amendments](https://www.iso-ne.com/static-assets/documents/2015/10/pa_amendments_composite_10_2015.pdf) and in an [MOU](https://www.iso-ne.com/static-assets/documents/regulatory/part_agree/mou_final.pdf) (memorandum of understanding) that also defines the relationship between these two entities and NESCOE (see below for more on NESCOE).
...
- Each state has its own utility commission, a regulatory body: Massachusetts Department of Public Utilities ([DPU](https://www.mass.gov/orgs/department-of-public-utilities)), Connecticut Public Utilities Regulatory Authority ([PURA](https://portal.ct.gov/PURA)), Maine Public Utilities Commission ([PUC](https://www.maine.gov/mpuc/)), New Hampshire Public Utilities Commission ([PUC](https://www.puc.nh.gov/)), Rhode Island Public Utilities Commission ([PUC](https://ripuc.ri.gov/)), and Vermont Public Utilities Commission ([PUC](https://puc.vermont.gov/)).
...
- At the state level, state environmental agencies oversee environmental regulatory programs, including for air, water, waste and land use. For example, the Massachusetts [DEP](https://www.sec.state.ma.us/cis/ciscig/g/g3g8.htm#:~:text=The%20Massachusetts%20Department%20of%20Environmental,waste%2C%20and%20land%20use%20controls.)“has the authority and responsibility for the management and control of air quality, regulation of the activities affecting wetlands, oversight and regulation of the quality of drinking water, management of water quality, control of pollution of all waters of the Commonwealth including groundwater, control of aquatic vegetation, regulation of the disposal of all solid wastes, the storage and transportation of hazardous wastes.” Other agencies are often responsible for fish and wildlife, and for recreational lands like parks.

### Why is electricity in New England so expensive these days?

- One reason is because our [grid relies significantly on natural gas](https://blog.ucsusa.org/paul-arbaje/why-energy-bills-will-be-even-higher-this-winter/), which makes up the biggest share of New England’s fuel mix. The market for natural gas is global, and when Russia invaded Ukraine, gas supplies in Europe were constrained, and global prices went up. That made our natural gas, and our electricity, more expensive. Natural gas is regularly imported into New England from domestic and international sources. New England is also a net importer of electricity which is generated from Canada and New York. See ISO-NE’s Explainer [here](https://www.iso-ne.com/static-assets/documents/2021/03/new_england_power_grid_regional_profile.pdf).
- Additionally, as ISO-NE [argues](https://www.iso-ne.com/about/what-we-do/in-depth/natural-gas-infrastructure-constraints), our region relies on just-in-time fuel delivered through pipelines, barges, or trucks. New England’s pipeline infrastructure is relatively small compared to other regions, and these factors result in greater imbalances in the supply and demand curve when supply cannot meet demand for these reasons.
- For more info, see slides from the [FTG-sponsored Electric Bills Webinar](https://docs.google.com/presentation/d/16ONiiV4gLXpZm69OEVe5JMRmn7lazmEOM-1vfyU_S98/edit?usp=sharing).

### Who runs ISO-NE?

- ISO-New England is run by a small [board of directors](https://www.iso-ne.com/about/corporate-governance/board/), while full time professional staff carry out daily operations.

### How do ISO employees get paid?

- To fund the services the ISO provides,[ISO-NE](https://www.iso-ne.com/about/what-we-do/in-depth/the-iso-funding-and-budgeting-process#:~:text=ISO%20New%20England%20is%20a,that%20use%20regional%20transmission%20services.) “collects fees from the buyers and sellers in the region’s wholesale electricity markets and from the customers that use regional transmission services. Those service rates are set at a level that lets them recover only what they need to operate.” Part of that operation cost is employee’s salaries.

### What is ISO New England’s mission statement?

- The [mission statement](https://www.iso-ne.com/about/corporate-governance/our-mission-vision-and-values/#:~:text=To%20harness%20the%20power%20of,region%20transitions%20to%20clean%20energy.) includes three main roles: “Through collaboration and innovation, ISO New England [plans the transmission system](https://www.iso-ne.com/about/what-we-do/three-roles/system-planning), [administers the region’s wholesale markets](https://www.iso-ne.com/about/what-we-do/three-roles/administering-markets), and [operates the power system](https://www.iso-ne.com/about/what-we-do/three-roles/operating-grid) to ensure reliable and competitively priced wholesale electricity.”
...
- The formal mission statement does not contain any reference to renewables or clean energy. However, a part of ISO-NE’s [vision for the future](https://www.iso-ne.com/about/corporate-governance/our-mission-vision-and-values/#:~:text=To%20harness%20the%20power%20of,region%20transitions%20to%20clean%20energy.) is “to harness the power of competition and advanced technologies to reliably plan and operate the grid as the region transitions to clean energy.” This vision is also outlined in their [strategic plan](https://www.iso-ne.com/static-assets/documents/2022/10/2022-strategic-plan-vision-in-action.pdf), including four pillars to support this vision, which entails “significant amounts of clean energy, balancing resources, energy adequacy, and transmission investment.” However, ISO-NE does not have a timetable with deadlines to realize concrete goals.
...
- There are three main ways that state officials can influence decision-making processes at ISO-NE:
  - Appealing to the NEPOOL Participants Committee: Multiple members of each sector, including municipal light departments, are registered as participants in NEPOOL. This includes a representative from the MA Attorney General’s Office, who sits as a Vice-Chair [(Source)](https://www.iso-ne.com/participate/participant-asset-listings/directory?id=1&type=committee). Public entities that sit as decision makers for NEPOOL would be subject to pressure from local or state officials.
  ...
  - The New England States Committee on Electricity ([NESCOE](https://nescoe.com/)) represents the collective perspectives of all six New England states in regional electricity matters. The governors in each state appoint members of NESCOE, but ISO-NE does not have to necessarily pass or implement NESCOE recommendations or policies. More information on the relationship between NESCOE and ISO-NE is available [here](https://pubs.naruc.org/pub/6BF1C563-1866-DAAC-99FB-8301548535A0) and more on how NESCOE has been actively pushing ISO-NE on clean energy can be found in [this article](https://www.utilitydive.com/news/new-england-states-call-for-changes-to-wholesale-markets-transmission-plan/587269/).
...
- Our grid uses electricity generated here in New England and imported from other regions including New York and Canada. About 45% of demand (or load) in 2022 was met by [natural gas](https://www.iso-ne.com/about/key-stats/resource-mix). Nuclear provided 23%, renewables including solar, wind, refuse and wood 11%, and non-imported hydropower 7%.
...
- The [fracked shale revolution,](https://www.eia.gov/todayinenergy/detail.php?id=38372) which has been ongoing for decades and subsidized by government money and ratepayers, has led to cheap natural gas. [In our region](https://www.iso-ne.com/about/what-we-do/in-depth/natural-gas-infrastructure-constraints), we’ve gone from 15% of our electricity mix consisting of natural gas in 2000, to over 45% today. The Marcellus play is closest to New England and most prolific. Environmental and health costs are externalized, meaning that we do not pay for them in the price of natural gas. [More recently](https://blog.ucsusa.org/paul-arbaje/why-energy-bills-will-be-even-higher-this-winter/), prices have skyrocketed due to shortages associated with the war in Ukraine.
